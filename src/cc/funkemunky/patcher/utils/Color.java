...
public class Color {
    ...
    public static String getColorFromString(String string) {
        if (string.contains("&")) {
            ...
            String color = (String) GrassPatcher.INSTANCE.getReflectionUtils().getFieldValue(GrassPatcher.INSTANCE.getReflectionUtils().getFieldByName(instance.getClass(), string), instance);
